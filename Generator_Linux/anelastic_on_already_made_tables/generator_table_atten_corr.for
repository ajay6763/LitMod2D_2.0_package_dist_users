...
C**********************************************************************
      ...
      REAL k
c     previous data
      Parameter(pi=3.1415926,AA1=750,alfa3=0.26,energi=424.0E3,
     *          volexp=1.25E-05,rgas=8.314472)
c  updated from Jackshon et.al 2010
c      Parameter(pi=3.1415926,AA1=68,alfa3=0.34,energi=293.0E03,
...
c    ...exponential term...
c       Pressure is converted to Pascal(SI) because P in Generated is in
c     bar. Temperature is already in Kelvin       
...
c      write(2,1003)aT,aP,vpat,vsat,difp,difs,avp,avs
       write(2,1010)aT,aP,ade,vpat,vsat,avpdt,avsdt,avpdp,avsdp,k
