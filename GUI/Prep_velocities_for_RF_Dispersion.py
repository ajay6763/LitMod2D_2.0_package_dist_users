########################################################################################################
########################################################################################################
#### This python script reads post_processing_output file from LitMod2D_2.0
#### and calculates Vp in the ctust baded on Brocher BSSA 2005 empirical relations
#### and then asks for a Vp/Vs value (constant in depth and along the profile)
#### to calculate Vs. 
#### Outputs from this script:
####       1. post_processing_output_crust_mantle.dat -- it includes velocities for crust
####	   2. It generates velocity input file for each node in profile lenght to read in CPS package
####             e.g. X_vel.dat where X stands for a nth node along the profile and on multiplying it with
####                  resolution along profile (km) would give you the distance(km).
########################################################################################################
########################################################################################################
...
## Asking for models info and Vp/Vs
...
###############################
#### Here Vp's are calculated and then Vs's from Vp's using Vp/Vs, along with Q 
#### Note that standard values are used from crustal Q
...
############################################################
#### Here writing new post_processing output file with crustal densities
...
############################################################
#### Now using new post_processing_output_crust_mantle.dat 
#### to produce velocity input files at each node along the 
#### profile to read in CPS (format is that of CPS velocity files)
#### Below 400km values from AK135 are hard plugged in.
