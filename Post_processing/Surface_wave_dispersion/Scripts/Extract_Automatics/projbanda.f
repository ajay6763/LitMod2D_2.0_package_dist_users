...
C
C    PER A PROJECTAR PUNTS SOBRE UN PERFIL AMB UNA AMPLADA DE BANDA
C    DETERMINADA. ELS PUNTS ES PROJECTEN DE FORMA PONDERADA AMB UNA
C    FUNCIO PES PREDEFINIDA.
C
C    INPUT: X,Z[,WEIGHT]   (X must increase monotonously)
C    OUPUT: XSAM,ZMEAN,SD
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
      DIMENSION X(200000),Y(200000),Z(200000),P(200000),ZP(200000)
